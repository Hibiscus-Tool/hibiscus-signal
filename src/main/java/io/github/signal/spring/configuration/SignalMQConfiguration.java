...
import io.github.signal.core.persistent.MqSignalPersistence;
...
public class SignalMQConfiguration {
    ...
    public SignalMQConfiguration(SignalProperties signalProperties, ObjectMapper objectMapper, RabbitTemplate rabbitTemplate, KafkaTemplate<String, String> kafkaTemplate) {
    ...
    @Bean
    @ConditionalOnProperty(name = "hibiscus.mq-enabled", havingValue = "true", matchIfMissing = false)
    public MqSignalPersistence mqSignalPersistence() {
        return new MqSignalPersistence(signalProperties, objectMapper, rabbitTemplate, kafkaTemplate);
    }
}
